...
export function ImportForm() {
  ...
  async function runImport() {
    ...
    try {
      ...
      // 2. Check for existing import (prevent duplicates)
      addLog("Kontroluji existující data...");
      ...
      if (existingCount && existingCount > 0) {
        throw new Error(
          `Import již byl proveden — v databázi existuje ${existingCount} zápasů pro sezónu ${SEASON}. Před opakováním importu je nejprve smaž.`
        );
      }

      // 3. Create or find player
